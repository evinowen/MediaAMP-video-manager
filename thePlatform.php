...
class ThePlatform_Plugin {
	...
	function add_admin_page() {
		$slug = 'theplatform';
		add_menu_page( 'MediaAMP', 'MediaAMP', $this->tp_editor_cap, $slug, array( $this, 'media_page' ), 'dashicons-video-alt3', '10.0912' );
		add_submenu_page( $slug, 'MediaAMP Video Browser', 'Browse Media', $this->tp_editor_cap, $slug, array( $this, 'media_page' ) );
		add_submenu_page( $slug, 'MediaAMP Video Uploader', 'Upload Media', $this->tp_uploader_cap, 'theplatform-uploader', array( $this, 'upload_page' ) );
		add_submenu_page( $slug, 'MediaAMP Plugin Settings', 'Settings', $this->tp_admin_cap, 'theplatform-settings', array( $this, 'admin_page' ) );
		add_submenu_page( $slug, 'MediaAMP Plugin About', 'About', $this->tp_editor_cap, 'theplatform-about', array( $this, 'about_page' ) );
		add_submenu_page( 'options.php', 'MediaAMP Plugin Uploader', 'Uploader', $this->tp_uploader_cap, 'theplatform-upload-window', array( $this, 'upload_window' ) );
	}
